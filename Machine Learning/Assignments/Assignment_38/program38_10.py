...
plt.figure(figsize=(8,5))
sns.scatterplot(data = df , x = df["SleepHours"] , y = df["FinalResult"] , hue = "FinalResult" , palette={0 : "red" , 1 : "green"})
...
'''
Sleep hours does not affect result 
Student sleeping more have passed 
Where as student sleeping less have failed
Overall based on study hours making prediction may result less accuracy of model
'''