...
def main():
    ...
    #-------------------------------------------
    # Step 9 : Test for unseen data
    #-------------------------------------------

    print("Step 9 : Test for unseen data")

    sample = pd.DataFrame([[6,148,72,35,0,33.6,0.627,50]],columns=X.columns)

    prediction = lr_model.predict(scaler.transform(sample))
